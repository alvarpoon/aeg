...
<script type="text/javascript">
	...
	function usp_content_prompt(e, c, ed) {
		...
		vex.dialog.open({
			...
			input:	'<p class="inline-blocks"><label for="label">Label</label><input type="text" value="" name="label" id="label"></p>' + 
					...
					'<p class="inline-blocks"><label for="cols">Number of columns <span>(default: 30)</span></label><input type="number" min="1" step="1" value="" name="cols" id="cols"></p>' + 
					'<p class="inline-blocks"><label for="rows">Number of rows <span>(default: 3)</span></label><input type="number" min="1" step="1" value="" name="rows" id="rows"></p>' + 
	...
	function usp_custom_prompt(e, c, ed) {
		...
		vex.dialog.open({
			...
			input:	'<p class="inline-blocks"><label for="id">Custom Field ID</label><input type="number" min="1" step="1" value="" name="id" id="id"></p>',
					//
			callback: function(data) {
				if (data === false) {
					return false;
	...
	function user_reset_prompt(e, c, ed) {
		...
		vex.dialog.open({
			...
			input:	'<p class="inline-blocks"><label for="value">Link text</label><input type="text" value="" name="value" id="value"></p>' + 
					...
					'<input type="text" value="http://example.com/submit/" name="url" id="url"></p>',
					//
			callback: function(data) {
				if (data === false) {
					return false;
	...
	function user_redirect_prompt(e, c, ed) {
		...
		vex.dialog.open({
			...
			input:	'<p class="inline-blocks"><label for="class">CSS classes <span>(comma-separated)</span></label><input type="text" value="" name="class" id="class"></p>' + 
					...
					'<input type="text" value="http://example.com/thank-you/" name="url" id="url"></p>',
					//
			callback: function(data) {
				if (data === false) {
					return false;
