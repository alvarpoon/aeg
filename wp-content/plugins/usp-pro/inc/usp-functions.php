...
/* 
	...
	Enable this option in the plugin settings, then tell your visitors about the following user shortcodes:
		...
		...
*/
if (!function_exists('usp_user_shortcode_img_1')) : 
...
if (!function_exists('usp_user_shortcode_img_2')) : 
...
if (!function_exists('usp_user_shortcode_img_3')) : 
...
if (!function_exists('usp_user_shortcode_img_4')) : 
...
if (!function_exists('usp_user_shortcode_img_5')) : 
...
*/
if (!function_exists('usp_user_shortcode_url')) : 
...
*/
if (!function_exists('usp_user_shortcode_link')) : 
...
*/
if (!function_exists('usp_user_shortcode_name')) : 
function usp_user_shortcode_name($content = null) {
	...
	if ($usp_uploads['user_shortcodes']) {
		if (usp_is_submitted($postID)) {
			$url = get_post_meta($postID, 'usp-author', true);
			$title  = get_the_title($postID);
			if (!empty($url) && !empty($title)) $return = '<a class="usp-user-submit-name" href="'. $url .'">'. $title .'</a>';
		}
	}
...
*/
if (!function_exists('usp_user_shortcode_file_1')) : 
function usp_user_shortcode_file_1($content = null) {
	...
	if ($usp_uploads['user_shortcodes']) {
		if (usp_is_submitted($postID)) {
			$url = get_post_meta($postID, $key, true);
			if ($url) $return = '<a class="usp-user-file-1" href="'. $url .'">'. __('File 1', 'usp') .'</a>';
		}
	}
...
if (!function_exists('usp_user_shortcode_file_2')) : 
function usp_user_shortcode_file_2($content = null) {
	...
	if ($usp_uploads['user_shortcodes']) {
		if (usp_is_submitted($postID)) {
			$url = get_post_meta($postID, $key, true);
			if ($url) $return = '<a class="usp-user-file-2" href="'. $url .'">'. __('File 2', 'usp') .'</a>';
		}
	}
...
if (!function_exists('usp_user_shortcode_file_3')) : 
function usp_user_shortcode_file_3($content = null) {
	...
	if ($usp_uploads['user_shortcodes']) {
		if (usp_is_submitted($postID)) {
			$url = get_post_meta($postID, $key, true);
			if ($url) $return = '<a class="usp-user-file-3" href="'. $url .'">'. __('File 3', 'usp') .'</a>';
		}
	}
...
/* 
	...
	Enable this option in the plugin settings, then tell your visitors about the following user shortcode:
		...
		(if you need more of these shortcodes, let me know or add your own via your theme's functions.php)
*/
if (!function_exists('usp_user_shortcode_item_1')) : 
...
if (!function_exists('usp_user_shortcode_item_2')) : 
...
if (!function_exists('usp_user_shortcode_item_3')) : 
...
*/
if (!function_exists('usp_user_shortcode_image')) : 
function usp_user_shortcode_image($attr) {
	...
	if ($usp_uploads['user_shortcodes'] && usp_is_submitted($postID) && !empty($attr['url'])) {
